...
/** XXX
claus-kleins-macbook-pro:etc clausklein$ tcpdump -i en1 -vv -X port ntp and udp
and ip6 multicast tcpdump: listening on en1, link-type EN10MB (Ethernet),
capture size 96 bytes 19:06:56.729622 IP6 (hlim 32, next-header: UDP (17),
length: 56) claus-kleins-macbook-pro.local.ntp > ff02::101.ntp: NTPv4, length 48
    Broadcast, Leap indicator: clock unsynchronized (192), Stratum 0, poll 6s,
precision -20 Root Delay: 0.000000, Root dispersion: 0.016708, Reference-ID:
(unspec) Reference Timestamp:  3569505079.497923284 (2013/02/10 18:11:19)
...
int main(int argc, char **argv) {
    ...
    // FIXME: ignore aliases to prevent mcast_join error: Address already in
    // use!
