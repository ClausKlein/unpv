...
19:06:56.729622 IP6 (hlim 32, next-header: UDP (17), length: 56) claus-kleins-macbook-pro.local.ntp > ff02::fb.ntp: NTPv4, length 48
...
//FIXME: ignore aliases to prevent mcast_join error: Address already in use!
	...
	if (ifihead) free_ifi_info(ifihead);
#endif
