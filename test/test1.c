...
//
// to start an tcp echo server:
// sudo nc -t -vvlp 7 -e /bin/cat
...
udp_01() {
    ...
    sockfd = UdpSockByAddr("195.34.89.241", 7); /* echo server */
     ...
     */
    sockfd = UdpConnSockByAddr("195.34.89.241", 7); /* echo server */
