...
struct rtt_info {
    double   rtt_rtt;    /* most recent measured RTT, in seconds */
    double   rtt_srtt;   /* smoothed RTT estimator, in seconds */
    double   rtt_rttvar; /* smoothed mean deviation, in seconds */
    double   rtt_rto;    /* current RTO to use, in seconds */
